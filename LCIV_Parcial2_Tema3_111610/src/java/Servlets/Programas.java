...
import Modelo.VMProgramasSubidos;
...
public class Programas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (modo.equals("alta")) {
            ...
            VMProgramasSubidos programas = new VMProgramasSubidos();
            programas.datosProgramas = gestor.infoProgramas(true);

            request.setAttribute("lista", programas.getDatosProgramas());
            request.setAttribute("titulo", "Programas Disponibles");
            RequestDispatcher rd = request.getRequestDispatcher("/listaProgramas.jsp");
            rd.forward(request, response);
        } else if (modo.equals("listadoAdmin")) {
            if (request.getSession().getAttribute("usr") != null) {
                VMProgramasSubidos programas = new VMProgramasSubidos();
                programas.datosProgramas = gestor.infoProgramas(false);
                request.setAttribute("lista", programas.getDatosProgramas());
                request.setAttribute("titulo", "Programas Disponibles");
                RequestDispatcher rd = request.getRequestDispatcher("/listaProgramas.jsp");
                rd.forward(request, response);
